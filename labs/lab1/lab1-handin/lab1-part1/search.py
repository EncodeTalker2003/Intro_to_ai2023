...
def depthFirstSearch(problem):
    ...
    while not fringe.isEmpty():  
        ...
        for next in problem.getSuccessors(state):
            n_state = next[0]
            n_actions = actions + [next[1]]
            fringe.push((n_state, n_actions))
    return list()
...
def uniformCostSearch(problem):
    ...
    while not fringe.isEmpty():
        ...
        for next in problem.getSuccessors(state):
            ...
            n_cost = cost + next[2]
            if n_state not in visited:
                fringe.push((n_state, n_cost, n_actions), n_cost)
    return list()
    ...
    while not fringe.isEmpty():
        ...
        if not state in visited:
            ...
            for next in problem.getSuccessors(state):
                ...
                n_cost = cost + next[2]
                n_path = path + [next[1]]
                fringe.push([n_state, n_cost, n_path], n_cost + heuristic(n_state, problem))
    return list()
